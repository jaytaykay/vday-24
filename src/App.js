      ...
      <ScrollControls pages={5} damping={0.1}>
        ...
        <Scroll html style={{ width: '100%' }}>
          ...
          <div className='row row-1 '>
            ...
            <p>Front-end developer. <br /> Machine learning enthusiast.<br /> Unreal Engine engineer.<br /> Bass acapella singer.<br /> Avid Gamer.</p>
          ...
          <div className='row row-2 col col-1'>
            <h2>My Projects</h2>
            <h3>HungryBees</h3>
            <p>A mobile application built in Java. <br /> Form or join groupbuy orders at your convenience</p>
            <a href={"https://tinyurl.com/hungrybees"} target="_blank" rel="noopener noreferrer">
              <button>Read more</button>
            </a>
            <h3>Project GSFI</h3>
            <p>A linear regression model built in pandas on a dataset of 108 countries. <br /> Visit the Flask website to predict existing or new country's food security index</p>
            <a href={"https://clickbeat.live/"} target="_blank" rel="noopener noreferrer">
              <button>Read more</button>
            </a>
            <h3>Web Developer at SPORES Singapore</h3>
            <p>Developed an innovative Telegram bot and web app to support the Singapore government's initiative to revitalize Orchard Road and attract a younger audience <br/>
          ...
          <div className='row row-3'>
            <h2>Credits</h2>
            <p>"CyberPunk Laptop" (https://skfb.ly/6SvyM) by Blue Odym is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).</p>
            <p>"Shanghai Bund" (https://polyhaven.com/a/shanghai_bund) by Greg Zaal on PolyHaven</p>
          </div>
